package org.insvtools.mp4parser.boxes.apple;
 ...
 * Copy-pasted from org.mp4parser.boxes.apple.QuicktimeTextSampleEntry, fixed issue with row text font name instead
 * of pascal text font name.
 */
